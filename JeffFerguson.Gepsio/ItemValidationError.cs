...
namespace JeffFerguson.Gepsio
{
    ...
    public class ItemValidationError : ValidationError
    {
        ...
        /// </param>
        internal ItemValidationError(Item item, string type, string message)
            : base(type, message)
        {
            this.Item = item;
        }
        ...
        /// </param>
        internal ItemValidationError(Item item, string type, string message, Exception exception)
